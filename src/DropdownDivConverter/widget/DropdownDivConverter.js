                    ...
                    this.connect(this.splitButton, "click", lang.hitch(this, function(e){
                        ...
                        var mfAction = {
                            ...
                            error       : lang.hitch(this, function(error) {
                                console.warn(this.id + "Error executing microflow");
                            })
                        };
                        ...
                        if (this.splitButtonClicked !== "" && this._contextObj) {
                            ...
                            mx.ui.action(this.splitButtonClicked, mfAction, this);
                        } else if (this.simpleSplitButtonClicked !== "") {
                            mfAction.params = {
                                applyto     : "none"
                            };

                            mx.ui.action(this.simpleSplitButtonClicked, mfAction, this);
                        }
                    }));
                }
            }
